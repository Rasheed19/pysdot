...
include_dirs = [
    ...
    "/usr/share/miniconda/envs/test/include",
    "$PREFIX/include",
...
class BuildPyCommand(setuptools.command.build_py.build_py):
    ...
    def run(self):
        ...
        if not os.path.isdir("./boost_1_87_0"):
            ...
            subprocess.run(
                "curl -L -o boost_1_87_0.tar.gz https://archives.boost.io/release/1.87.0/source/boost_1_87_0.tar.gz",
                check=True,
                shell=True,
            )
...
setup(
    ...
    packages=find_packages(
        exclude=["hugo", "ext", "build", "dist", "examples", "results", "tests"]
    ),
    cmdclass={
